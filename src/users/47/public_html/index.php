    ...
    $company_id = getCompanyIdByUser($conn, 47);
...
<?php
    ...
    $company = getCompanyByUser($conn, 47);
    ...
    if ($company) 
    {
        ...
        <header>
        <img src="../../../users/<?php echo 47; ?>/images/logo/logo.png" class="logo" alt="Logo" >
            <div class="titleInfo">
                <div>
        ...
        <main>
            <div class="imageContainer"> <!-- Kuvan taustalle tulostuu sama kuva, jos kuva ei peitä koko aluetta -->
                <div class="imageDiv" ><img src="../../../users/<?php echo 47; 
        ...
        <footer>
            <div class="footercontainer">
                ...
                <img src="../../../users/<?php echo 47; ?>/images/logo/logo.png" class="footerlogo" alt="Logo" >
            </div>
            <hr>
