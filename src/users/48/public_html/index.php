    ...
    $company_id = getCompanyIdByUser($conn, 48);
...
<?php
    ...
    $company = getCompanyByUser($conn, 48);
    ...
    if ($company) 
    {
        ...
        <header>
        <img src="../../../users/<?php echo 48; ?>/images/logo/logo.png" class="logo" alt="Logo" >
            <div class="titleInfo">
                <div>
        ...
        <main>
            <div class="imageContainer"> <!-- Kuvan taustalle tulostuu sama kuva, jos kuva ei peitä koko aluetta -->
                <div class="imageDiv" ><img src="../../../users/<?php echo 48; 
        ...
        <footer>
            <div class="footercontainer">
                ...
                <img src="../../../users/<?php echo 48; ?>/images/logo/logo.png" class="footerlogo" alt="Logo" >
            </div>
            <hr>
