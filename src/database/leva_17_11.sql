...
--
-- Host: mysql_db
-- Generation Time: 17.11.2024 klo 18:57
...
(35, 'Katri', 'Helena', 'Katri', 'katri@helena.fi', '$2y$10$X4FXRCHF1XHMDGEPxy/ZiOtwHXkIvIwVU6KD23eVtHNTuvlyl2wgy', 'customer', NULL, '2024-11-17 18:19:18', '2024-11-17 18:19:18'),
(36, 'Pallo', 'Pää', 'PalloPää', 'pallo@paa.fi', '$2y$10$NeYjEuluGRc71f7GdJCbx./IHYE1v.aUpd5DsLbSnVIZURveWb8jO', 'customer', NULL, '2024-11-17 18:34:49', '2024-11-17 18:34:49'),
(37, 'Heidi', 'Kyrö', 'Heidi', 'heidi@kyro.fi', '$2y$10$WIdBozXy64XTH0/vigHHnenoNr39PpCMHs21KuJxDGuFUmmVb8TRi', 'customer', NULL, '2024-11-17 18:47:24', '2024-11-17 18:47:24');
...
--
ALTER TABLE `company`
  MODIFY `company_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `company_style`
--
ALTER TABLE `company_style`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
