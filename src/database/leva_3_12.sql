...
--
-- Host: mysql_db
-- Generation Time: 03.12.2024 klo 18:02
...
(43, 'Salama McQueen', '4569871-5', 'Vauhtikatu 7', '10100', 'Syylari city', 'autot@autot.fi', '040698698', 'Doc paljastaa McQueenille, miksi hän ei enää kilpaile: Doc jätettiin pois Piston Cupista pahan kolarin vuoksi. Hän kertoo myös tulleensa Syylari Cityyn, jottei häntä enää löydettäisi ja ettei hän ikinä erehtyisi palaamaan. McQueen huomaa, että Doc on itsekäs koska hän ei ole kertonut muille, kuka hän itse asiassa on. Sitä McQueenkin oli ennen tätä hetkeä. Hän korjaa tien loppuun ja luo kaupungin asukkaiden kanssa ystävyyssuhteita tutustumalla kaupungin palveluihin. Hän myös toi kaupungille taas syyn toivoon siitä, että Syylari City palaisi takaisin kartalle. Kesken romanttisen hetken Sallin kanssa McQueen löydetään ja viedään Kaliforniaan. Salli järkyttyy siitä, että Doc on antanut etsijöille vinkin McQueenista, luullen McQueenin pois lähdön olleen kaupunkilaisten parhaaksi. Näin ei kuitenkaan ollut ja Doc huomaa, että McQueen oli hänen suhteensa oikeassa.\n\nMcQueenin kisan alkaessa hän yrittää keskittyä siihen normaalisti, mutta Syylari Cityssä vietetyn viikon muistot hämäävät häntä. Nämä muistot miltei keskeyttävät hänen kisansa, mutta sitten seuraa yllätys: Doc ja lähes kaikki Syylari Cityn asukkaat ovat tulleet hänen varikkotiimikseen, ja McQueenin itseluottamus sekä kilpailukyky palaavat. Uusien ystäviensä tuella hän on jo voittamassa kisan, mutta lopussa Jasu saa tarpeekseen ja tönäisee Kunkun röyhkeästi ulos radalta, jolloin Kunkku vahingoittuu pahasti. Huomatessaan tämän McQueen muistaa, miten Docin kilpailu-ura päättyi, ja hän pysähtyy juuri ennen maaliviivaa antaen Jasun voittaa. Kaikki huomio keskittyy kuitenkin McQueeniin hänen lähtiessään Kunkun avuksi ja työntäessään tämän maaliin. Jasu ei saa yhtään kunnioitusta voitostaan. Tappiosta huolimatta Kunkun varikkotiimin, Dinocon, omistaja Tex Dinoco tarjoaa McQueenille paikkaa Dinocossa, mutta McQueen kieltäytyy kohteliaasti. Tex kuitenkin sanoo, että McQueen voisi silti pyytää mitä vain. Hetken kuluttua hän sanookin: ”Mul olis kyllä yks juttu…” tarkoittaen sillä Martin toivomaa helikopterilentoa. Lopuksi McQueen palaa Syylari Cityyn, joka on taas kartalla hänen ansiostaan, koska hän siirsi tallinsa päämajan sinne.', 46, '2024-12-03 18:01:14', 'salama-mcqueen.php', 'Mä oon salaman nopee');
...
(13, 43, '#FFFFFF', '#333333', '#004080', '#F1F1F1', 'Arial, sans-serif', 'Verdana, sans-serif', 'Tahoma, sans-serif', '2024-12-03 18:01:14');
...
(35, 'Katri Mirjami', 'Helena', 'Katri', 'katri@helena.fi', '$2y$10$X4FXRCHF1XHMDGEPxy/ZiOtwHXkIvIwVU6KD23eVtHNTuvlyl2wgy', 'admin', NULL, '2024-11-17 18:19:18', '2024-12-03 17:48:30', NULL),
...
(46, 'Salama', 'McQueen', 'Salama', 'salama@autot.fi', '$2y$10$CQ/Bw8PL1HTTO4JJj1C80OVmzh394p8YiREatuTG80zW3uhRK7A.6', 'customer', NULL, '2024-12-03 17:59:27', '2024-12-03 17:59:27', NULL);
...
--
ALTER TABLE `company`
  MODIFY `company_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `company_style`
--
ALTER TABLE `company_style`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
